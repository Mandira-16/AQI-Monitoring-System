...
namespace AQI_Monitoring_System.Models
{
    public class RegisterViewModel
    {
        ...
        public string Username { get; set; } = string.Empty; // Add ? for nullable

        [Required(ErrorMessage = "Email is required")]
        [EmailAddress(ErrorMessage = "Invalid email address")]
        public string Email { get; set; } = string.Empty; // Add ? for nullable
        ...
        public string Password { get; set; } = string.Empty; // Add ? for nullable

        [Required(ErrorMessage = "Confirm password is required")]
        [Compare("Password", ErrorMessage = "Passwords do not match")]
        [DataType(DataType.Password)]
        public string ConfirmPassword { get; set; } = string.Empty; // Add ? for nullable
